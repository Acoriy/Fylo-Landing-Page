...
const Headre = () => {
  ...
  return (
    ...
    // <header ref={header} className="fixed z-[20] w-full pt-[60px] lg:h-fit">
    ...
    //         </Link>
    //      </div> */}
    //     <div className={`${isOpen ? "translate-x-0" : "-translate-x-full"} lg:hidden absolute top-20   left-0 flex flex-col w-full  text-center  bg-[#0c1534] `}>
    //       <Link to="home" spy={true} smooth={true} duration={500} className="text-white opacity-[0.9] hover:opacity-[1] hover:underline transition-opacity duration-200 ease-in-out cursor-pointer" onClick={MenuClose}>Home</Link>
    //       <Link to="featchers" spy={true} smooth={true} duration={500} className="text-white opacity-[0.9] hover:opacity-[1] hover:underline transition-opacity duration-200 ease-in-out cursor-pointer" onClick={MenuClose}>Featchers</Link>
    //       <Link to="stayproductive" spy={true} smooth={true} duration={500} className="text-white opacity-[0.9] hover:opacity-[1] hover:underline transition-opacity duration-200 ease-in-out cursor-pointer" onClick={MenuClose}>Stayproductive</Link>
    //       <Link to="testimonials" spy={true} smooth={true} duration={500} className="text-white opacity-[0.9] hover:opacity-[1] hover:underline transition-opacity duration-200 ease-in-out cursor-pointer" onClick={MenuClose}>Testimonials</Link>
    //       <Link to="getStarted" spy={true} smooth={true} duration={500} className="text-white opacity-[0.9] hover:opacity-[1] hover:underline transition-opacity duration-200 ease-in-out cursor-pointer" onClick={MenuClose}>GetStarted</Link>
    //     </div>
    // </header>
  );
};
